...
describe('ProductsPage module boundary', () => {
  it('delegates columns and modal rendering to product components', () => {
    ...
    expect(source).toContain("from '../components/products/ProductEditorModal'");
    expect(source).toContain("from '../components/products/ProductDetailModal'");
    ...
    expect(source).toContain("from '../components/products/useProductManagement'");
