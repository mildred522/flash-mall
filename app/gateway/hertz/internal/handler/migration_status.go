...
func RouteMigrationStatusHandler() app.HandlerFunc {
	return func(ctx context.Context, c *app.RequestContext) {
		ok(ctx, c, RouteMigrationStatusResp{
			Groups: []RouteMigrationGroup{
				{
					...
					Notes: "Health and migration visibility are live; metrics and monitor need an internal-only policy.",
				},
				{
					Name:   "shop",
					Status: "partial",
					...
					Notes: "Catalog/product reads, product image static access, and user-owned address routes are canonical in Hertz; UI shell remains planned.",
				},
				{
					Name:   "auth",
					Status: "live",
				...
				},
				{
					...
					Notes: "Merchant profile, application, dashboard, product operations, order work queue, shipping, and refund queue are live; stock audit view still needs migration.",
				},
				{
					Name:   "compatibility",
					Status: "temporary",
