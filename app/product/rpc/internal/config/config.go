...
type Config struct {
	...
	DisableStockRepair         bool `json:",optional"` //nolint:staticcheck // go-zero config uses optional in json tags.
	LegacyStockMutationEnabled bool `json:",optional"` //nolint:staticcheck // go-zero config uses optional in json tags.
}
