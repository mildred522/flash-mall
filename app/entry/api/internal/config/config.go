...
type Config struct {
	...
	ProductCardSnapshotRefreshEnabled         bool
	ProductCardSnapshotRefreshIntervalSeconds int64
	ProductCardSnapshotRefreshWindowMinutes   int64
	ProductCardSnapshotRefreshLimit           int64
