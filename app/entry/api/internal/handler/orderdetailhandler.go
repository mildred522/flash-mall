...
SELECT o.id, o.user_id, o.product_id, o.amount, o.status, o.create_time,
...
LIMIT 1`, orderID, userID).Scan(
		&resp.OrderId, &resp.UserId, &resp.ProductId, &resp.Amount, &resp.Status, &resp.CreateTime,
	...
	resp.PaymentStatusText = paymentStatusText(resp.PaymentStatus)
	return &resp, nil
}
