...
func RegisterHandlers(server *rest.Server, serverCtx *svc.ServiceContext) {
	...
	server.AddRoutes(
		[]rest.Route{
			...
			{Method: http.MethodPost, Path: "/api/merchant/products/stock-adjust", Handler: MerchantProductStockAdjustHandler(serverCtx)},
			{Method: http.MethodGet, Path: "/api/merchant/inventory/stock-changes", Handler: MerchantStockChangeLogHandler(serverCtx)},
	...
	server.AddRoutes(
		rest.WithMiddlewares(adminMW,
			...
			rest.Route{Method: http.MethodGet, Path: "/api/admin/inventory/stock-changes", Handler: AdminStockChangeLogHandler(serverCtx)},
			rest.Route{Method: http.MethodPost, Path: "/api/admin/inventory/stock-snapshots/rebuild", Handler: AdminStockSnapshotRebuildHandler(serverCtx)},
			rest.Route{Method: http.MethodPost, Path: "/api/admin/products/card-snapshots/refresh", Handler: AdminProductCardSnapshotRefreshHandler(serverCtx)},
