...
func (s *OrderServer) RequestRefund(ctx context.Context, in *order.LifecycleOrderReq) (*order.LifecycleOrderResp, error) {
	l := logic.NewRequestRefundLogic(ctx, s.svcCtx)
	return l.RequestRefund(in)
}

func (s *OrderServer) ApproveRefund(ctx context.Context, in *order.LifecycleOrderReq) (*order.LifecycleOrderResp, error) {
	l := logic.NewApproveRefundLogic(ctx, s.svcCtx)
	return l.ApproveRefund(in)
}
