...
docker exec -i mysql mysql --default-character-set=utf8mb4 -uroot -p6494kj06 < scripts/k8s/schema.sql
docker exec -i mysql mysql --default-character-set=utf8mb4 -uroot -p6494kj06 < scripts/k8s/demo-seed.sql
